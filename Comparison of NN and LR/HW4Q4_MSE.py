# -*- coding: utf-8 -*-
"""5 features NNR and LR using keras_MSE.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1kj2QhXRy0hPeoyupKd_wM_Z3Yx6afbu3
...
#Plotting the heatmap for selected 20 features
...
plot_loss(history)
plt.title('Linear regression Model MSE losses across epochs')
...
plt.title('Linear rergession performance using MSE')

pd.DataFrame(test_results, index=['Mean squared error [shares]']).T
...
plot_loss(history)
plt.title('NN Model MSE losses across epochs')
